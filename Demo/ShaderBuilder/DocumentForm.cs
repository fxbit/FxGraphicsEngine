    ...
    public partial class DocumentForm : DockContent
    {
        ...
        private void DocumentForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (Scintilla.Modified)
            {
                ...
                DialogResult dr = MessageBox.Show(this, message, "Builder", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Exclamation);
        ...
        private void scintilla_StyleNeeded(object sender, StyleNeededEventArgs e)
        {
            // Style the _text
            if (_iniLexer)
                ShaderBuilder.IniLexer.StyleNeeded((Scintilla)sender, e.Range);
        }
