...
namespace Delaunay
{
	...
	public struct csMergeHInfo
	{
		...
		internal void WriteToDataStream(DataStream MergeHInfoData)
		{
			MergeHInfoData.Write(threadID);
			MergeHInfoData.Write(UpHEStack);
			MergeHInfoData.Write(DownHEStack);

			MergeHInfoData.Write(UpFirstThreadID);
			MergeHInfoData.Write(DownFirstThreadID);
			MergeHInfoData.Write(UpLastThreadID);
			MergeHInfoData.Write(DownLastThreadID);
		}
	};
	...
	public struct csMergeVParams
	{
		...
		/// <summary>
		/// Write the struct to stream
		/// </summary>
		/// <param name="stream"></param>
		public void WriteToDataStream(DataStream stream)
		{

			RegionSidesID.WriteToDataStream(stream);
	...
	public struct csMergeHParams
	{
		...
		public void WriteToDataStream(DataStream stream)
		{
			UpBN.WriteToDataStream(stream);
			DownBN.WriteToDataStream(stream);
		}
	};
}
